...
require("lazy").setup({
	{ import = "plugins" },
	-- { dir = "/Users/paul/projects/incubator/nvim-exec-scratch/" },
})
-- require("exec-scratch").setup()
...
vim.keymap.set("n", "<leader>e", vim.diagnostic.open_float, { desc = "Show diagnostic floating window" })
...
vim.api.nvim_create_user_command("Rnd", function()
	local result = vim.trim(vim.fn.system("LANG=C tr -dc a-zA-Z0-9 </dev/random | head -c32"))
